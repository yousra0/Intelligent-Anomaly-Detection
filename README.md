...
- Garder les notebooks pour l'exploration et la demonstration.
- Deplacer la logique stable dans `src/`.
- Appeler les fonctions `src/` depuis les notebooks et les pipelines.
- Sauvegarder tous les artefacts dans `outputs/` et `data/processed/`.
